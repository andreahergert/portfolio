    ...
    <div style={styles.space}>
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          front-end, the app can be accessed at Heroku. On the back-end, this is
          a node command line application that utilizes sequilize, dotenv,
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          The text editor runs in a browser and can be installed on a computer.
        </p>
      </section>
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          mongoose, express, and moment to view, create, update, and delete data
          from the database using Insomnia or MongoDB Compass.
        </p>
      </section>
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          Bootcamp. On the front-end, the app can be accessed at Heroku. On the
          back-end, this is a node command line application that utilizes
          sequilize, dotenv, mysql2, express, handlebars, dayjs, and bcrypt. The
          Motivation Station is an app where users can keep track of their
          goals.
        </p>
      </section>
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          Bootcamp. It allows users to input departments, roles, and employees,
          update an employee's role, and view a table of departments, roles, and
          employees.
        </p>
      </section>
      ...
      <section className="card">
        ...
        <p style={styles.space}>
          ...
          page uses HTML, CSS, Javascript, and the Open Weather API to create a
          functioning weather forecast for a city.
        </p>
      </section>
    </div>
  );
